            ...
            Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SubTitle(
                        title: 'Rate:', subTitle: register.ratePerHour, bottom: 24),
                    SubTitle(
                        title: 'Shift timing:',
                            ...
                            children: [
                              Expanded(
                                  child: OutlinedButton.icon(
                                      onPressed: loading ? null: () {accept(register.id.toString(), false, context); },
                                      icon:
                              ...
                              Expanded(
                                  child: ElevatedButton.icon(
                                      onPressed:loading ? null: () {accept(register.id.toString(), true, context); },
